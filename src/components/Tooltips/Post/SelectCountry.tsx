...
import { SelectContinentPostTooltipData } from '../../../constant/TooltipData'
...
const heading = SelectContinentPostTooltipData[0]
const paragraph = SelectContinentPostTooltipData[1]
