...
interface ITermsAndConditon {
  setOpenTermsAndConditions: React.Dispatch<React.SetStateAction<boolean>>
}
const TermsAndCondition: React.FC<ITermsAndConditon> = ({ setOpenTermsAndConditions }) => {
    ...
    >
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={{ paddingLeft: 12 }}>
          <GoBackArrowContent onPress={() => setOpenTermsAndConditions(false)}>
