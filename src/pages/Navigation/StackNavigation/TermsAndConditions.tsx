  ...
  return (
    ...
    >
      <ScrollView showsHorizontalScrollIndicator={false}>
        ...
        <NormalText>
          a. When you place an order through the app, you agree to pay for the products or services
          ordered at the prices specified, including any applicable taxes and shipping fees.
        </NormalText>
        <NormalText>
        ...
        <NormalText>
          a. We may terminate or suspend your account and access to the app, with or without notice,
        ...
        <NormalText>
          a. For questions or concerns regarding these Terms and Conditions, please contact us using
          the contact information provided on the Clothing App. By using the Clothing App, you
          acknowledge that you have read, understood, and agreed to these Terms and Conditions. If
          you do not agree to these terms, please do not use the app. Your continued use of the app
          indicates your acceptance of these terms and any updates or revisions.
        </NormalText>
